...
#.────────────────────────────────────────────
# Backend - Node-RED flows and configuration
#────────────────────────────────────────────
# backend package.json
cat > "$BACKEND_DIR/package.json" <<EOF
{
 "name": "Node-RED IoT System Project Backend",
 "description": "A backend server for IoT System Project Backend",
 "version": "0.0.1",
 "private": true
} 
EOF
...
# backend flows_cred.json
cat > "$BACKEND_DIR/flows_cred.json" <<EOF
{
 "$": "a37a3f99e7888b009b7a6f9d3b84e74485w="
}
EOF
...
# backend settings.js
cat > "$BACKEND_DIR/settings.js" <<'EOF'
/**
...
* https://nodered.org/docs/userguide/runtime/configuration
*
...
module.exports = {
    ...
    ******************************************************************************/
    ...
    //},
    /** Option 2: function that returns the HTTP
     ...
     * See https://nodered.org/docs/security.html#generating-thepassword-hash
     */
    ...
    */
     ...
     * in the HTTP nodes.
     * See https://github.com/troygoode/nodecors#configuration-options for
     ...
     * called http_proxy (or HTTP_PROXY) outside of NodeRED in the operating system.
     ...
     * e.g. if httpStatic = "/home/nol/docs" and
    httpStaticRoot = "/static/"
    * then "/home/nol/docs" will be served at
    "/static/"
    ...
    */
    ...
    // methods: "GET,PUT,POST,DELETE"
    //},
    /** The following property can be used to modify proxy
    options */
    // proxyOptions: {
    ...
    *******************/
    ...
    diagnostics: {
        ...
        enabled: true,
        /** enable or disable diagnostics display in the
        node-red editor. Must be set to `false` to disable */
        ui: true,
    },
    /** Configure runtimeState options
     * - enabled: When `enabled` is `true` flows runtime can be Started/Stopped
     * by POSTing to available at http://localhost:1880/flows/state
     * - ui: When `ui` is `true`, the action `core:startflows` and
     * `core:stop-flows` will be available to logged in
    users of node-red editor
    * Also, the deploy menu (when set to default) will
    show a stop or start button
    */
    runtimeState: {
    ...
    logging: {
        ...
        console: {
             ...
             * trace - record very detailed logging + debug
            + info + warn + error + fatal errors
     ...
     * This allows them to be displayed in the ContextSidebar within the editor.
    ...
    *******************/
     ...
     * See https://nodered.org/docs/userguide/runtime/configuration#editor-themes
     * for all available options.
     */
    editorTheme: {
        /** The following property can be used to set a custom theme for the editor.
         * See https://github.com/node-red-contribthemes/theme-collection for
        ...
        codeEditor: { 
            ...
            options: {
                 ...
                 * packages/node_modules/@node-red/editorclient/src/vendor/monaco/dist/theme
                 * e.g. "tomorrow-night", "upstreamsunburst", "github", "my-theme"
                 */
                // theme: "vs",
                /** other overrides can be set e.g. fontSize, fontFamily, fontLigatures etc.
                 * for the full list, see https://microsoft.github.io/monacoeditor/docs.html#interfaces/editor.IStandaloneEditorConstru ctionOptions.html
                 */
                //fontSize: 14,
...
echo "MQTT topics published by BLE container:"
echo "   sensor/temperature"
echo "   sensor/humidity"
echo "MQTT client container will print received messages to its logs."
echo " "    
